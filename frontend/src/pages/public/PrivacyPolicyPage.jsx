                ...
                <div className="space-y-8">
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 mt-2 text-gray-300 space-y-2">
                            <li>
                                Adınız, e-posta adresiniz, kullanıcı adınız gibi
                                hesap bilgileri
                            </li>
                            <li>
                                Profil resminiz ve diğer paylaştığınız içerikler
                            </li>
                            <li>Cihaz bilgileri ve IP adresi</li>
                            <li>
                                Uygulama içi etkinlikleriniz ve tercihleriniz
                            </li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 mt-2 text-gray-300 space-y-2">
                            ...
                            <li>
                                Hizmet sağlayıcılarımızla (veri depolama, analiz
                                gibi)
                            </li>
                    ...
                    <section>
                        ...
                        <p className="text-gray-300">
                            Bilgilerinizi korumak için teknik ve organizasyonel
                            önlemler alıyoruz. Ancak hiçbir güvenlik sistemi
                            %100 güvenli değildir ve bunu garanti edemeyiz.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-gray-300">
                            ...
                            güncelleyebiliriz. Önemli değişiklikler olduğunda
